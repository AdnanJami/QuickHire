      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '32px 24px' }}>
        ...
        <div style={{ display: 'grid', gridTemplateColumns: 'repeat(3, 1fr)', gap: 20, marginBottom: 32 }}>
          {[
            ...
            <div key={label} style={{ background: 'white', border: '1.5px solid #F3F4F6', padding: 24, display: 'flex', gap: 16, alignItems: 'center' }}>
              <div style={{ width: 48, height: 48, background: color,  display: 'flex', alignItems: 'center', justifyContent: 'center' }}>
        ...
        {/* Notifications */}
        {success && (
          <div style={{ background: '#F0FFF4', border: '1.5px solid #86EFAC', padding: '12px 16px', marginBottom: 20, display: 'flex', gap: 8, alignItems: 'center' }}>
            <CheckCircle size={16} color="#16A34A" />
            <span style={{ color: '#15803D', fontWeight: 600, fontSize: 14 }}>{success}</span>
          </div>
        )}
        {error && (
          <div style={{ background: '#FEF2F2', border: '1px solid #FECACA', padding: '12px 16px', marginBottom: 20, display: 'flex', gap: 8, alignItems: 'center' }}>
        ...
        {/* Tabs */}
        <div style={{ display: 'flex', gap: 0, marginBottom: 24, background: 'white', border: '1.5px solid #F3F4F6', padding: 6, width: 'fit-content' }}>
        ...
        {activeTab === 'jobs' && (
          <div>
            ...
            {/* New Job Form */}
            {showForm && (
              <div style={{ background: 'white', border: '1.5px solid #EEF1FF', padding: 32, marginBottom: 24 }}>
                  ...
                  <div key={job._id} style={{
                    ...
                    <div style={{ flex: 1, minWidth: 0 }}>
                      <div style={{ display: 'flex', alignItems: 'center', gap: 10, marginBottom: 4 }}>
                        ...
                        {job.featured && (
                          <span style={{ background: '#FFF3E0', color: '#D97706', padding: '2px 8px', fontSize: 11, fontWeight: 600 }}>
                            Featured
                          </span>
                        )}
                      </div>
              ...
              <div style={{ display: 'flex', flexDirection: 'column', gap: 12 }}>
                {applications.map(app => (
                  <div key={app._id} style={{
                    ...
                    <p style={{ color: '#374151', fontSize: 14, lineHeight: 1.6, background: '#F9FAFB', padding: '10px 14px' }}>
                      {app.cover_note}
                    </p>
                  </div>
                ))}
