    ...
    <div style={{ paddingTop: 72, background: '#F9FAFB', minHeight: '100vh' }}>
      ...
      <div style={{ maxWidth: 1200, margin: '0 auto', padding: '40px 24px', display: 'grid', gridTemplateColumns: '1fr 420px', gap: 32 }}>
        ...
        <div>
          ...
          <div style={{ background: 'white', borderRadius: 20, border: '1.5px solid #F3F4F6', padding: 32, marginBottom: 24 }}>
            <div style={{ display: 'flex', alignItems: 'flex-start', gap: 20, marginBottom: 20 }}>
              <div
                ...
                style={{ width: 64, height: 64, fontSize: 26, borderRadius: 16, background: getLogoColor(job.company), flexShrink: 0 }}
              >
              ...
              <div style={{ flex: 1 }}>
                ...
                <div style={{ display: 'flex', alignItems: 'center', gap: 12, flexWrap: 'wrap' }}>
                  ...
                  <span style={{ background: '#EEF1FF', color: '#2B4EFF', padding: '3px 10px', borderRadius: 20, fontSize: 12, fontWeight: 600 }}>
                    {job.type}
                  </span>
                  <span style={{ background: '#F0FFF4', color: '#16A34A', padding: '3px 10px', borderRadius: 20, fontSize: 12, fontWeight: 600 }}>
                    {job.category}
                  </span>
                  {job.featured && (
                    <span style={{ background: '#FFF3E0', color: '#D97706', padding: '3px 10px', borderRadius: 20, fontSize: 12, fontWeight: 600 }}>
                      ⭐ Featured
                    </span>
                  )}
                </div>
          ...
          <div style={{ background: 'white', borderRadius: 20, border: '1.5px solid #F3F4F6', padding: 32 }}>
            <h2 style={{ fontFamily: 'Syne', fontWeight: 700, fontSize: 18, color: '#1A1A2E', marginBottom: 16 }}>
              Job Description
            </h2>
            <p style={{ color: '#374151', lineHeight: 1.85, fontSize: 15, whiteSpace: 'pre-wrap' }}>
              {job.description}
            </p>
            ...
            {(job.tags || []).length > 0 && (
              <div style={{ marginTop: 24 }}>
                ...
                <div style={{ display: 'flex', gap: 8, flexWrap: 'wrap' }}>
                  {job.tags.map((tag, i) => (
                    <span key={i} style={{ background: '#EEF1FF', color: '#2B4EFF', padding: '5px 14px', borderRadius: 20, fontSize: 13, fontWeight: 600 }}>
                      {tag}
                    </span>
                  ))}
                </div>
          ...
          <div style={{
            ...
            <div style={{ padding: '24px 24px 16px', borderBottom: '1px solid #F3F4F6', flexShrink: 0 }}>
              <div style={{ display: 'flex', alignItems: 'center', justifyContent: 'space-between' }}>
                <h2 style={{ fontFamily: 'Syne', fontWeight: 800, fontSize: 20, color: '#1A1A2E' }}>
                  Applicants
                </h2>
                {!loadingApps && (
                  <div style={{
              ...
              <p style={{ color: '#9CA3AF', fontSize: 13, marginTop: 4 }}>
                People who applied for this role
              </p>
            </div>
            ...
            <div style={{ overflowY: 'auto', flex: 1, padding: '12px 16px' }}>
              {loadingApps ? (
                ...
                <div style={{ textAlign: 'center', padding: '48px 20px' }}>
                  ...
                  <h3 style={{ fontFamily: 'Syne', fontWeight: 700, fontSize: 16, color: '#374151', marginBottom: 6 }}>
                    No applicants yet
                  </h3>
                    ...
                    >
                      ...
                      >
                        ...
                        <div style={{ flex: 1, minWidth: 0 }}>
                          <div style={{ fontFamily: 'Syne', fontWeight: 700, fontSize: 14, color: '#1A1A2E', marginBottom: 2 }}>
                            {app.name}
                          </div>
      ...
      <style>{`
        ...
        @media (max-width: 960px) {
          div[style*='gridTemplateColumns: 1fr 420px'] {
